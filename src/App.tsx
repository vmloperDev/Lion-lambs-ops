...
function App() {
  ...
  const [docsTypeFilter, setDocsTypeFilter] = useState<'All' | 'Breakdown' | 'Quotation' | 'Invoice' | 'Service Voucher'>('All')
          ...
          <section className="docs-hub-panel">
            ...
            <div className={`docs-hub-cards ${docsTypeFilter !== 'All' ? 'docs-hub-cards--single' : ''}`}>
              {(() => {
                ...
                const renderList = (
                  targetScreen: 'invoice-preview' | 'quotation-preview' | 'voucher-preview' | 'breakdown-preview',
                  list: BookingRecord[],
                  noBase: boolean,
                  noMatch: boolean,
                  emptyLabel: string
